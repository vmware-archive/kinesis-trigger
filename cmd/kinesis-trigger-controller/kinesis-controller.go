...
import (
	...
	"github.com/kubeless/kinesis-trigger/pkg/controller"
	kinesisutils "github.com/kubeless/kinesis-trigger/pkg/utils"
	"github.com/kubeless/kinesis-trigger/pkg/version"
...
var rootCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		kinesisClient, err := kinesisutils.GetTriggerClientInCluster()
		if err != nil {
			logrus.Fatalf("Cannot get Kinesis trigger CR API client: %v", err)
		}
